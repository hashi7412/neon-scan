...
interface VerifySolcJsonStatus {
    licenseType:            number
    code:                   string
    option:                 number
    abiEncoded:             string
    ...
    return (
        ...
        <div className='verify'>
            <section className='container'>
                <h3 className='text-center'>VerifySolcJson & Publish Contract Source Code</h3>
                ...
                <TabBar headers={tabHeader} onChange={tabKey=>setStatus({...status, tabKey})}>
                    {status.tabKey === 'Contract Source Code' && (
                        <form onSubmit={onSubmit}>
                            ...
                            <div className='panel'>
                                <div className="input-field">
                                    <label htmlFor="code">Please select the Standard-Input-Json (*.json) files for upload *</label>
